...
import { GetChargeAppliesTo } from './get-charge-applies-to';
import { GetChargeCalculationType } from './get-charge-calculation-type';
import { GetChargePaymentMode } from './get-charge-payment-mode';
import { GetChargeTimeType } from './get-charge-time-type';
import { GetChargesCurrency } from './get-charges-currency';

/**
 * 
 * @export
 * @interface GetProductsCharges
 */
export interface GetProductsCharges {
    /**
     * 
     * @type {number}
     * @memberof GetProductsCharges
     */
    id?: number;
    /**
     * 
