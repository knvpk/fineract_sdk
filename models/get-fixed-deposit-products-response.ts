...
import { GetFixedDepositProductsAccountingRule } from './get-fixed-deposit-products-accounting-rule';
import { GetFixedDepositProductsCurrency } from './get-fixed-deposit-products-currency';
...
import { GetFixedDepositProductsInterestCompoundingPeriodType } from './get-fixed-deposit-products-interest-compounding-period-type';
import { GetFixedDepositProductsInterestPostingPeriodType } from './get-fixed-deposit-products-interest-posting-period-type';
import { GetFixedDepositProductsMaxDepositTermType } from './get-fixed-deposit-products-max-deposit-term-type';
import { GetFixedDepositProductsMinDepositTermType } from './get-fixed-deposit-products-min-deposit-term-type';

/**
 * GetFixedDepositProductsResponse
 * @export
 * @interface GetFixedDepositProductsResponse
 */
export interface GetFixedDepositProductsResponse {
    /**
     * 
     * @type {number}
     * @memberof GetFixedDepositProductsResponse
     */
    id?: number;
    /**
     * 
